...
module.exports = config => {
  ...
  log('Using mailer :', typeof config.emails.mailer === 'string' ? config.emails.mailer : 'custom mailer');
  const mailer = typeof config.emails.mailer === 'string' ? require(`../lib/mailers/${config.emails.mailer}`)(config) : config.emails.mailer;
